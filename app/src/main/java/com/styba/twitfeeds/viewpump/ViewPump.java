...
public final class ViewPump {
    ...
    public static final class Builder {
         ...
         *
         * <p> If you disable this you will need to override your {@link android.app.Activity#onCreateView(View, String, Context, android.util.AttributeSet)}
         ...
         *
         * On HoneyComb+ this is inside the {@link android.app.Activity#onCreateView(View, String, Context, android.util.AttributeSet)}
         *
         ...
         * specific place. We have to mimic this in {@link ViewPumpLayoutInflater#createCustomViewInternal(View, View, String, Context, android.util.AttributeSet)}
